            ...
            <table>
                ...
                <tbody>
                    {mode === 'display' ?
                        ...
                        : mode === 'update' ?
                            <tr><UpdateComponent songDetails={selectedSong} updateSong={updateSong} goBack={goBack} /></tr>
                            :
                            <tr><DeleteComponent songDetails={selectedSong} deleteSong={deleteSong} goBack={goBack} /></tr>
                    }
                </tbody>
            </table>
        </div>
